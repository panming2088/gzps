...
public class MaintainMapActivity extends BaseActivity implements IDrawerController {

    private DrawerLayout drawer_layout;
    private ViewGroup progress_linearlayout;
    private MaintainMapFragment uploadDistributeMapFragment;
...
//        });
        ...
        uploadDistributeMapFragment = MaintainMapFragment.getInstance(bundle);
