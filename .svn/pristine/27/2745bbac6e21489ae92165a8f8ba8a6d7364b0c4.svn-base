...
public class MyDoubtListActivity extends BaseActivity {

    private DrawerLayout drawer_layout;
    private int fAdd = 0, fChecked = 0, pipeAdd = 0, pipeCheck = 0, pipeDelete = 0;
    private MyDoubtListFragment addComponentFragment;
    private MyDoubtPagerAdapter adapter;
    ...
    private void initView() {
        ((TextView) findViewById(R.id.tv_title)).setText("我的存疑记录");
        ...
        new DoubtListFilterConditionView(this, "存疑区域列表筛选", FacilityFilterCondition.DOUBT_AREA_LIST, llModifiedFilterCondition);

        final ViewGroup llUploadFilterCondition = (ViewGroup) findViewById(R.id.ll_upload_filter_condition);
        new DoubtListFilterConditionView(this, "存疑管井列表筛选", FacilityFilterCondition.DOUBT_WELL_LIST, llUploadFilterCondition);


        final ViewPager viewPager = (ViewPager) findViewById(R.id.viewPager);
        viewPager.setOffscreenPageLimit(2);
        adapter = new MyDoubtPagerAdapter(getSupportFragmentManager(),
                this);
