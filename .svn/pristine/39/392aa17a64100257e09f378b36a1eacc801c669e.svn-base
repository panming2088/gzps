...
public class ReparationFacilityMapActivity extends BaseActivity implements IDrawerController {
    protected ProgressLinearLayout progress_linearlayout;
    protected DrawerLayout drawer_layout;

    private ReparationFacilityMapFragment addComponentFragment;
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_reparationmap);
        ...
        findViewById(R.id.ll_search).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent =new Intent(UploadFacilityMapActivity.this,MyUploadStatisticActivity.class);
        ...
        addComponentFragment = new ReparationFacilityMapFragment();
