...
public class UploadDoorNoDetailActivity extends BaseActivity implements IDrawerController {

    private DrawerLayout drawer_layout;
    private ViewGroup progress_linearlayout;
    private UploadDoorNoDetailMapFragment uploadDistributeMapFragment;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        UploadDoorNoDetailBean uploadDoorNoDetailBean = (UploadDoorNoDetailBean) getIntent().getSerializableExtra("uploadDoorNoDetailBean");
        Bundle bundle = new Bundle();
        bundle.putSerializable("uploadDoorNoDetailBean",uploadDoorNoDetailBean);
        uploadDistributeMapFragment = UploadDoorNoDetailMapFragment.getInstance(bundle);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        uploadDistributeMapFragment.onActivityResult(requestCode,resultCode,data);
