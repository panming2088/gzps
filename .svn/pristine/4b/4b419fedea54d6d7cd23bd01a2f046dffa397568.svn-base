...
public class MyFeedbackTableViewManager {
    ...
    private TextItemTableItem tableitem_check_id;

    public MyFeedbackTableViewManager(
            Context context,
...
//                }
                ...
                if(!StringUtil.isEmpty(modifiedFacility.getOLDOID())){
                    tableitem_check_id.setText(modifiedFacility.getOLDOID());
                }
            }
    ...
    private void setReadOnlyAttributes(Map<String, Object> originAttrs) {
        ...
        if ("窨井".equals(modifiedIdentification.getLayerName())) {
            ...
            YinjingAttributeViewUtil.addReadOnlyAttributes(mContext, originAttrs, yinjingAttributes, ll_container,null,null,null);
    ...
    private void initView() {
        ...
        root = LayoutInflater.from(mContext).inflate(R.layout.view_myfeedback_facility_table_view, null);
        ...
        tableitem_checkstate.setReadOnly();
        tableitem_check_id = (TextItemTableItem) root.findViewById(R.id.tableitem_check_id); //审核状态
        tableitem_check_id.setReadOnly();
