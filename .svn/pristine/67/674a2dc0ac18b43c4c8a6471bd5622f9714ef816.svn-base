...
public class DoubtListFilterConditionView {
     ...
     * @param viewGroup
     */
    public DoubtListFilterConditionView(Context context, String filterTitle, String filterListType , ViewGroup viewGroup) {
    ...
    private View initView(String filterTitle) {
        final View root = View.inflate(mContext, R.layout.view_doubt_filter, null);
