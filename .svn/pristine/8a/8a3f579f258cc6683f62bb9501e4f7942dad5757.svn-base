...
public class YuShuiKouAttributes {
     ...
     * 属性是否可以为空
     */
    public static final boolean ATTRIBUTE_ONE_CAN_NULL = true;
    public static final boolean ATTRIBUTE_THREE_CAN_NULL = true;
    public static final boolean ATTRIBUTE_FOUR_CAN_NULL = true;
