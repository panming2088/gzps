...
public class UploadJbjMonitorDetailActivity extends BaseActivity implements IDrawerController {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        WellMonitorInfo uploadFacility = (WellMonitorInfo) getIntent().getParcelableExtra("data");
        ...
        UploadJbjMonitorDetailMapFragment uploadDistributeMapFragment = UploadJbjMonitorDetailMapFragment.getInstance(bundle);
