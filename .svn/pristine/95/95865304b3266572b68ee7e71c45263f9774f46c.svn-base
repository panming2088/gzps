...
public class ReadOnlyGuaPaiNoPfKouView {
    ...
    public ReadOnlyGuaPaiNoPfKouView(Context context, String attributekey, String attributeValue, List<Photo> wellPhotos) {
    ...
    private void initView(String attributekey, String attributeValue, List<Photo> wellPhotos) {
        mMenPaiView = LayoutInflater.from(mContext).inflate(R.layout.layout_attribute_guapai_no, null);
//        mMenPaiView = View.inflate(mContext, R.layout.layout_attribute_five, null);
        et = (EditText) mMenPaiView.findViewById(R.id.et_1);
        takePhotoTableItem = (MultiTakePhotoTableItem) mMenPaiView.findViewById(R.id.take_photo_pfkou);
