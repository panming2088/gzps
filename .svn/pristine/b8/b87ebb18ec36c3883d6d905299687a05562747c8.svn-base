...
public class PhoneItemTableItem extends RelativeLayout {

    private TextView tv_left;
    private EditText et_right;
    private View tv_requiredTag;

    public PhoneItemTableItem(Context context) {
        this(context,null);
    }

    public PhoneItemTableItem(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        et_right.setInputType(InputType.TYPE_CLASS_PHONE);
//        et_right.setFilters(new InputFilter[]{new NumberDecimalFilter().setDigits(2)});
