...
import com.augurit.agmobile.gzps.journal.view.detaillist.DayPatrolDetailFragment;
...
public class DayPatrollDetailActivity extends BaseActivity implements IDrawerController {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        drawer_layout.setDrawerLockMode(DrawerLayout.LOCK_MODE_LOCKED_CLOSED,
                GravityCompat.END);
        ((TextView)findViewById(R.id.tv_title)).setText("巡检日志详情");
        ...
        DayPatrolDetailFragment uploadDistributeMapFragment = DayPatrolDetailFragment.getInstance(bundle);
