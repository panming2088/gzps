...
public class MyAddPipeListFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mSearchResultAdapter.setOnItemClickListener(new BaseRecyclerAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position, long id) {
                ...
                intent.putExtra("isShowCancelDeleteButton", 1);
    ...
    public void loadDatas(boolean ifShowPb) {
        ...
        identificationService.getLinePipeByPerson(page, LoadDataConstant.LOAD_ITEM_PER_PAGE, checkState, 1, mUploadedFacilityFilterCondition)
...
//                        }
    ...
    public void refreshList(FacilityFilterCondition uploadedFacilityFilterCondition) {
        ...
        if (FacilityFilterCondition.NEW_PIPE_LIST.equals(uploadedFacilityFilterCondition.filterListType)) {
            page = 1;
            isIfReceivedAddFacilitySum = false;
