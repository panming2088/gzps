...
public class SelectMenPaiActivity extends BaseActivity implements IDrawerController {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        SelectMenPaiFragment selectLocationFragment = SelectMenPaiFragment.getInstance(bundle);
