...
public class SelectRiverFlowActivity extends BaseActivity implements IDrawerController {
...
//                .newInstance(geometry, initScale);
        ...
        SelectRiverFlowFragment selectLocationFragment = SelectRiverFlowFragment.getInstance(bundle);
