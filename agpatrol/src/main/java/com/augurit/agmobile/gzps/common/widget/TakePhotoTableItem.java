...
public class TakePhotoTableItem extends LinearLayout {
    ...
    private Callback1<Photo> onDeletePhotoListener;
...
//    private ImageView iv_open_photo;
    ...
    public TakePhotoTableItem(Context context) {
        this(context, null);
    }

    public TakePhotoTableItem(Context context, AttributeSet attrs) {
        super(context, attrs);
                        ...
                        new ImageUtil.OnDeletedPhotoListener() {
                            ...
                            public void onDeletedPhoto() {
                                if (onDeletePhotoListener != null) {
                                    onDeletePhotoListener.onCallback(selectedPhotos.get(position));
                                }
...
//    }
    ...
    public void setPhotoNumShow(boolean show, int maxNum) {
        if (show) {
            tv_photo_num.setVisibility(VISIBLE);
        } else {
    ...
    public void setOnDeletePhotoListener(Callback1<Photo> onDeletePhotoListener) {
