...
import com.augurit.agmobile.gzps.doorno.service.SewerageComponentService;
...
public class SewerageSelectComponentFragment extends Fragment implements View.OnClickListener {
    ...
    public static SewerageSelectComponentFragment getInstance(Bundle data) {
        SewerageSelectComponentFragment addComponentFragment2 = new SewerageSelectComponentFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return View.inflate(mContext, R.layout.fragment_select_component2, null);
    }
...
//                            }
        ...
        */
        ...
        //修改标题
        ((TextView) view.findViewById(R.id.tv_title)).setText("排水单元选择");
...
//        }
        ...
        private void query(double x,double y) {
            ...
            SewerageComponentService componentMaintenanceService = new SewerageComponentService(mContext.getApplicationContext());
            if(true){
                    ...
                    public void onSuccess(List<Component> components) {
                        ...
                        if (ListUtil.isEmpty(components)) {
                            mMapView.postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    showCalloutMessage("没有找到排水单元", null, null);
                                }
                            },200);
...
//        //显示callout
        String PSDY_NAME = String.valueOf(component.getGraphic().getAttributes().get("PSDY_NAME"));
        defaultMapOnTouchListener.showCalloutMessage(PSDY_NAME, null, new View.OnClickListener() {
            @Override
            public void onClick(View view) {
