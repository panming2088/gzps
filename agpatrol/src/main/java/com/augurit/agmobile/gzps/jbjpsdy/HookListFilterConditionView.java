...
public class HookListFilterConditionView {
    ...
    private String[] facilityTypeConditions = {"全部", "雨水", "污水", "雨污合流"};
     ...
     * @param viewGroup
     */
    public HookListFilterConditionView(Context context, String filterTitle, String filterListType , ViewGroup viewGroup) {
    ...
    // fixme 把这里从“private”修改成“public”，是为了在自定义的子类中对这个方法进行覆盖，从而实现对布局进行
    //  一定的修改，而不至于直接复制所有代码，也不至于修改这里的其他代码
    public View initView(String filterTitle) {
        final View root = View.inflate(mContext, R.layout.view_hook_history_filter, null);
