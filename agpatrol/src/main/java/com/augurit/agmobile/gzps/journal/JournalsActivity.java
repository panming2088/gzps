...
public class JournalsActivity extends BaseActivity implements IDrawerController {

    protected ProgressLinearLayout progress_linearlayout;
    protected DrawerLayout drawer_layout;

    private JournalsFragment addComponentFragment;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        addComponentFragment = new JournalsFragment();
