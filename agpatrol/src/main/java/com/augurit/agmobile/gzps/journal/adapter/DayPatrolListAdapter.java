...
public class DayPatrolListAdapter extends RecyclerView.Adapter<DayPatrolListAdapter.MyViewHolder> {
    ...
    public DayPatrolListAdapter(List<EventAffair.EventAffairBean> list, Context context) {
        this.listData = list;
    ...
    @Override
    public DayPatrolListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = View.inflate(context, R.layout.day_patrol_list_item, null);
