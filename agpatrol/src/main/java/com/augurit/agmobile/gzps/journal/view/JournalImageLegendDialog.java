...
public class JournalImageLegendDialog extends DialogFragment {
    ...
    public static JournalImageLegendDialog newInstance() {

        JournalImageLegendDialog legendDialog = new JournalImageLegendDialog();
        return legendDialog;
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View view = inflater.inflate(R.layout.journal_legend_image_dialog,container);
