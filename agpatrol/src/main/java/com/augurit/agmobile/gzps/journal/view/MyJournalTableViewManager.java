...
public class MyJournalTableViewManager {
    ...
    public MyJournalTableViewManager(
            Context context,
...
//            yinjingAttributes.setAttributeFour(modifiedIdentification.getAttrFour());
            ...
            YinjingAttributeViewUtil.addReadOnlyAttributesForJournal(mContext, originAttrs, yinjingAttributes, ll_container);
        ...
        if ("排水口".equals(modifiedIdentification.getLayerName())) {
            ...
            yinjingAttributes.setAttributeOne(modifiedIdentification.getTqzq());
//            yinjingAttributes.setAttributeTwo(modifiedIdentification.getPskpszt());
//            yinjingAttributes.setAttributeThree(modifiedIdentification.getGpbh());
            yinjingAttributes.setAttributeFour(modifiedIdentification.getClff());
            yinjingAttributes.setAttributeFive(modifiedIdentification.getCljg());
            yinjingAttributes.setAttributeSix(modifiedIdentification.getAdnd());
            yinjingAttributes.setAttributeSeven(modifiedIdentification.getPh());
            PaifangKouAttributeViewUtil.addReadOnlyAttributes(mContext, originAttrs, yinjingAttributes, ll_container);

//            if ("持续流水".equals(modifiedIdentification.getPskpszt())) {
            if (!TextUtils.isEmpty(modifiedIdentification.getVideoPath())) {
                ll__psk_video.setVisibility(View.VISIBLE);
                iv_video.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {

                        String extension = MimeTypeMap.getFileExtensionFromUrl(modifiedIdentification.getVideoPath());
                        String mimeType = MimeTypeMap.getSingleton().getMimeTypeFromExtension(extension);
                        Intent mediaIntent = new Intent(Intent.ACTION_VIEW);
                        mediaIntent.setDataAndType(Uri.parse(modifiedIdentification.getVideoPath()), mimeType);
                        mContext.startActivity(mediaIntent);
                    }

                });
            }else{
                ll__psk_video.setVisibility(View.GONE);
            }
//            }
    ...
    private void initView() {
         ...
         * 排水口视频
         */
        ll__psk_video = root.findViewById(R.id.ll__psk_video);
        iv_video = (ImageView) root.findViewById(R.id.iv_video);
        /**
         * 城中村/三不管
         */
