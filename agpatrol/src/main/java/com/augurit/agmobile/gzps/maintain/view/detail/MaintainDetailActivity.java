...
public class MaintainDetailActivity extends BaseActivity implements IDrawerController {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        drawer_layout.setDrawerLockMode(DrawerLayout.LOCK_MODE_LOCKED_CLOSED,
                GravityCompat.END);
        ((TextView)findViewById(R.id.tv_title)).setText("养护情况详情");
        ...
        ConserveDetail modifiedFacility = getIntent().getParcelableExtra("data");
        Geometry geometry = (Geometry) getIntent().getSerializableExtra("geometry");
        Boolean isEdit = getIntent().getBooleanExtra("ISEDIT",false);
        Bundle bundle = new Bundle();
        bundle.putParcelable("uploadedFacility",modifiedFacility);
        bundle.putSerializable("geometry", geometry);
        bundle.putBoolean("ISEDIT",isEdit);
        MaintainDetailFragment uploadDistributeMapFragment = MaintainDetailFragment.getInstance(bundle);
