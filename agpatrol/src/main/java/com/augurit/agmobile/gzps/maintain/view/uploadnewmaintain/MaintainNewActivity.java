...
public class MaintainNewActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        ((TextView) findViewById(R.id.tv_title)).setText("新增养护");
                    ...
                    public void call(Void aVoid) {
                        ...
                        countDownTimer = new CountDownTimer(UploadFacilityService.TIMEOUT * 1000, 1000) {
                            ...
                            public void onTick(long millisUntilFinished) {
                                ...
                                if (time % 20 == 0) {
                                    ToastUtil.longToast(MaintainNewActivity.this, "网络忙，请稍等");
                                }
                            }
                                ...
                                .subscribe(new Subscriber<ResponseBody>() {
                                    ...
                                    public void onError(Throwable e) {
                                        ...
                                        CrashReport.postCatchedException(new Exception("新增上报失败，上报用户是：" +
                                                BaseInfoManager.getUserName(MaintainNewActivity.this) + "原因是：" + e.getLocalizedMessage()));
                                    }
                                    ...
                                    public void onNext(ResponseBody responseBody) {
                                        ...
                                        if (responseBody.getCode() == 200) {
                                            ...
                                            CrashReport.postCatchedException(new Exception("新增上报失败，上报用户是：" +
                                                    BaseInfoManager.getUserName(MaintainNewActivity.this) + "原因是：" + responseBody.getMessage()));
                                        }
                                    }
                                });
                    }
