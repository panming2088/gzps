 ...
 */
public class ReparationFacilityAddressErrorView {
    ...
    private TextItemTableItem tableitem_correct_distrct;

    public ReparationFacilityAddressErrorView(Context context,
                                              Component component) {
    ...
    private void initView(final ModifiedFacility modifiedFacility) {
        ...
        root = View.inflate(mContext, R.layout.view_reparation_component_address_error, null);
        ...
        tableitem_correct_distrct = (TextItemTableItem) root.findViewById(R.id.tableitem_correct_district);
        tableitem_correct_distrct.setRequireTag();
...
//        }
    ...
    public void onReceivedSendMapFeatureEvent(SendMapFeatureEvent sendMapFeatureEvent) {
        ...
        tableitem_correct_distrct.setText(detailAddress.getDistrict());
        if (sendMapFeatureEvent.getGraphic().getGeometry() instanceof Point) {
            Point point = (Point) sendMapFeatureEvent.getGraphic().getGeometry();
