...
//                district = data.getParentOrgName();
            ...
            }else if(data.getSource().equals("correct")){
//                desctiption =   "校核数据(" + StringUtil.getNotNullString(data.getLayerName(),"") +
//                        StringUtil.getNotNullString(data.getCorrectType(),"")+")";
                desctiption =   "校核数据("+ StringUtil.getNotNullString(data.getLayerName(),"") + ")数据";
            }else{//delete
                desctiption =   "删除数据("+ StringUtil.getNotNullString(data.getLayerName(),"") + ")数据";
            }
