...
import com.augurit.agmobile.gzps.uploadfacility.view.facilitydetail.UploadPipeDetailMapFragment;
...
public class PipeAffairDetailActivity extends BaseActivity implements IDrawerController {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        PipeBean uploadFacility = getIntent().getParcelableExtra("data");
        Bundle bundle = new Bundle();
        bundle.putParcelable("uploadedFacility",uploadFacility);
        UploadPipeDetailMapFragment uploadDistributeMapFragment = UploadPipeDetailMapFragment.getInstance(bundle);
