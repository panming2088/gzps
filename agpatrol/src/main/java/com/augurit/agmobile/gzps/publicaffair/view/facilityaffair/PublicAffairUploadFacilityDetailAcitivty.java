...
/**
 * 事务公开中上报设施列表中的『上报设施』详情
 *
 * Created by xcl on 2017/11/17.
 */

public class PublicAffairUploadFacilityDetailAcitivty extends BaseActivity implements IDrawerController {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        bundle.putBoolean("isShiPaiOrKexuecheng", getIntent().getBooleanExtra("isShiPaiOrKexuecheng",false));
       ...
       // final FacilityAffairDistributeMapFragment problemListMapFragment = FacilityAffairDistributeMapFragment.getInstance(modifiedFacility);
