...
import com.augurit.agmobile.gzps.uploadfacility.view.KeyNodeMonitorListAdapter;
import com.augurit.agmobile.gzps.uploadfacility.view.facilitydetail.UploadJbjMonitorDetailActivity;
import com.augurit.agmobile.gzps.uploadfacility.view.facilitydetail.UploadKeyNodeMonitorDetailActivity;
...
public class MyKeyNodeMonitorListFragment extends Fragment {

    private KeyNodeMonitorListAdapter mSearchResultAdapter;
...
//    private TextView tv_sum;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_my_add_hook, null);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        ((TextView)view.findViewById(R.id.check_ing)).setText(InspectionSetCheckStateUtil.CHECK_ING);
        ((TextView)view.findViewById(R.id.check_no_pass)).setText(InspectionSetCheckStateUtil.CHECK_NO_PASS);
        ((TextView)view.findViewById(R.id.check_pass)).setText(InspectionSetCheckStateUtil.CHECK_PASS);
...
//        tv_sum = (TextView) view.findViewById(R.id.tv_sum);
        ...
        mSearchResultAdapter = new KeyNodeMonitorListAdapter(mContext, new ArrayList<InspectionWellMonitorInfo>());
        ...
        mSearchResultAdapter.setOnItemClickListener(new BaseRecyclerAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position, long id) {
                ...
                inspectionWellMonitorInfo.setPhotos(Attachment2PhotoUtil.toPhotos(inspectionWellMonitorInfo.getAttachments()));
                Intent intent = new Intent(mContext, UploadKeyNodeMonitorDetailActivity.class);
                intent.putExtra("data", (Parcelable) inspectionWellMonitorInfo);
    ...
    public void loadDatas(boolean ifShowPb) {
        ...
        identificationService.getKeyNodeJcCorrect(page, LoadDataConstant.LOAD_ITEM_PER_PAGE,checkState,2,mUploadedFacilityFilterCondition)
                .map(new Func1<Result3<List<InspectionWellMonitorInfo>>, List<InspectionWellMonitorInfo>>() {
                    @Override
                    public List<InspectionWellMonitorInfo> call(final Result3<List<InspectionWellMonitorInfo>> listResult2) {
                            ...
                            public void run() {
                                ...
                                if (listResult2 == null) {
                                    ...
                                    if (listResult2.getTotal() != null) {
                                        sum = Integer.parseInt(listResult2.getTotal());
                                    }
//                                    tv_sum.setText("监测总数量：" + sum + "条");
                                    all_count.setText(sum+"");
                                ...
                                event.setStatus(6);
                                event.setKeynode(sum);
                                EventBus.getDefault().post(event);
                            }
                        });
                        List<InspectionWellMonitorInfo> identifications = new ArrayList<>();

                        List<InspectionWellMonitorInfo> data = listResult2.getData();
                        return data;
                    }
                })
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe((Observer<? super List<InspectionWellMonitorInfo>>) new Subscriber<List<InspectionWellMonitorInfo>>() {
                    @Override
                    ...
                    @Override
                    public void onNext(List<InspectionWellMonitorInfo> modifiedIdentifications) {
...
//                        tv_component_counts.setText("一共有：" + mSearchResultAdapter.getDataList().size() + "条数据");
    ...
    public void refreshList(FacilityFilterCondition uploadedFacilityFilterCondition){
        ...
        if (FacilityFilterCondition.KEY_NODE_MONITOR_LIST.equals(uploadedFacilityFilterCondition.filterListType)) {
            page = 1;
            isIfReceivedAddFacilitySum = false;
