...
public class AreasAdapter extends BaseAdapter {
    ...
    private List<Area> assigneerList;
    private int selectedPosition = -1;// 选中的位置

    private OnRecyclerItemClickListener<Area> mOnItemClickListener;

    public AreasAdapter(Context context){
        this.mContext = context;
    }

    public void notifyDatasetChanged(List<Area> assigneerList){
        this.assigneerList = assigneerList;
        notifyDataSetChanged();
    }

    public void notifyDatasetChanged(List<Area> assigneerList, int selPosition){
        this.assigneerList = assigneerList;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final Area assigneer = assigneerList.get(position);
        area_name.setText(assigneer.getName());
    ...
    public void setOnItemClickListener(OnRecyclerItemClickListener<Area> onItemClickListener){
