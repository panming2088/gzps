...
public class UploadFacilityMapActivity extends BaseActivity implements IDrawerController {
    protected ProgressLinearLayout progress_linearlayout;
    protected DrawerLayout drawer_layout;

    private UploadFacilityMapFragment addComponentFragment;
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        addComponentFragment = new UploadFacilityMapFragment();
