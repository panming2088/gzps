...
public class PipeOpinionViewManager {


    private View root;

    public PipeOpinionViewManager(Context context, List<ApprovalOpinion> opinions) {

        initView(context, opinions);
    }

    public PipeOpinionViewManager(Context context, Long markId) {
    ...
    private void initView(final Context context, Long markId) {
    ...
    private void loadData(final Context context,
        ...
        approvalOpinionService.getlinePipeCheckRecord(markId)
