...
public class ReadOnlySfCzwsclView {
    ...
    public ReadOnlySfCzwsclView(Context context, String attributekey, String oldValue, String value) {
    ...
    private void initView(String attributekey, String oldValue, String value) {
        fCzwsclView = LayoutInflater.from(mContext).inflate(R.layout.layout_attribute_sfczwscl, null);
