...
public class DoorNoListFilterConditionView {
     ...
     * @param context
     * @param filterTitle
     * @param filterListType 过滤的列表类型
     * @param viewGroup
     */
    public DoorNoListFilterConditionView(Context context, String filterTitle, String filterListType , ViewGroup viewGroup) {
    ...
    private View initView(String filterTitle) {
        final View root = View.inflate(mContext, R.layout.view_door_no_history_filter, null);
...
//                DoorNoFilterCondition condition = new DoorNoFilterCondition(
//                        mFilterListType,
//                        type);
                DoorNoFilterCondition condition = new DoorNoFilterCondition(
