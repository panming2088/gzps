...
public class MyDoubtAreaListFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mSearchResultAdapter.setOnItemClickListener(new BaseRecyclerAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position, long id) {
                ...
                String layerUrl = getLayerUrlForName(PatrolLayerPresenter.RIVER_DOUBT_LAYER_NAME)+"/0";
                ...
                intent.putExtra("layerName", "面".equals(doubtBean.getLayerName())?"存疑区域":doubtBean.getLayerName());
    ...
    public void loadDatas(boolean ifShowPb) {
        ...
        mIdentificationService.getDoubtMark(page, LoadDataConstant.LOAD_ITEM_PER_PAGE,null,3, mFacilityFilterCondition)
                //获取列表（不包含附件）
...
//                                    BaseInfoManager.getUserName(mContext) + "原因是：" + s.getMessage()));
    ...
    public void onRefreshList(FacilityFilterCondition facilityFilterCondition) {
        if (FacilityFilterCondition.DOUBT_AREA_LIST.equals(facilityFilterCondition.filterListType)) {
