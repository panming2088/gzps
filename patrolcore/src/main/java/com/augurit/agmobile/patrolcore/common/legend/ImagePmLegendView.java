...
public class ImagePmLegendView extends BaseView<ILegendPresenter> implements ILegendView {

    private ImagePmLegendDialog lineDialog;
    private List<GroupLegend> allGpLegends;

    public ImagePmLegendView(Context context) {
    ...
    protected void initView() {
        ...
        lineDialog = ImagePmLegendDialog.newInstance();
