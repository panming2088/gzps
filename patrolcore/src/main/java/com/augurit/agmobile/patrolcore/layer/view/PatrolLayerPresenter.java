...
public class PatrolLayerPresenter extends LayerPresenter {
    ...
    public static final String JOURNAL_LAYER_NAME = "巡检日志";
    ...
    public static final String DRAINAGE_UNIT_LAYER_BZ = "排水单元注记";
    public static final String DRAINAGE_JIEBOJING = "接驳井.";
    public static final String DRAINAGE_GJJD = "关键节点";
    public static final String DRAINAGE_PSHMP = "排水户门牌";
    public static final String DRAINAGE_JCQK = "检测情况";
    public static final String DRAINAGE_PUMPING_STATION = "泵站水闸拍门";

    public PatrolLayerPresenter(ILayerView layerView, ILayersService layersService) {
        super(layerView, layersService);
    }

    public PatrolLayerPresenter(ILayerView layerView) {
                    ...
                    public void onNext(List<LayerInfo> layerInfos) {
                        for (LayerInfo layerInfo : layerInfos) {
                            if (layerInfo.getLayerName().equals(partlayerName) && layerInfo.isDefaultVisible() != visible) {
                                 ...
                                 * 无法回调{@link PatrolLayerPresenter#onClickCheckbox(String, int, LayerInfo, boolean)}方法
                                 */
